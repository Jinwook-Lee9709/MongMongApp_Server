...
const Contact = () => {
  return (
    <div className="bg-white py-20 lg:py-36">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-12 max-w-4xl mx-auto">
          <div className="bg-white shadow rounded-xl overflow-hidden">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12648.625411475476!2d127.17677053955076!3d37.57493580000001!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357cb16372eb14ef%3A0x1ed516c17e3c4e4d!2z7ZiE64yA7YG065-s7Iqk7YSwIOuvuOyCrDPssKg!5e0!3m2!1sko!2skr!4v1760939178352!5m2!1sko!2skr"
              width="100%"
              height="400"
              allowfullscreen=""
              loading="lazy"
